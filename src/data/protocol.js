...
export const PROTOCOL = [
  // ───────────────────────────────────────────────────────────────── A ──
  {
    id: 'a',
    lletra: 'A',
    titol: 'La nova versió actualitzada del Protocol',
    apartats: [
      {
        id: 'a-1',
        contingut: [
          {
            t: 'p',
            text: 'Aquesta nova versió del Protocol pren com a base i actualitza l’aprovada l’any 2006, la qual va ser modificada per darrer cop al Ple municipal de 31 de maig de 2010.',
          },
          {
            t: 'p',
            text: 'El nou redactat del Protocol s’estructura tenint en compte l’acord del Govern de la Generalitat de Catalunya 104/2016, de 19 de juliol, pel qual es declara Festa patrimonial d’interès nacional la Festa Major de Sitges en honor a sant Bartomeu i santa Tecla, unes celebracions que s’entenen com a un únic fet festiu pel fet que els dos sants són copatrons de la vila.',
          },
          {
            t: 'p',
            text: 'Aquest protocol utilitza el genèric masculí, el qual engloba totes les persones que participen en la Festa. Quan s’ha trobat un terme neutre s’ha fet servir.',
          },
          { t: 'sub', text: 'La nova versió aporta, respecte a l’anterior' },
          {
            t: 'ul',
            items: [
              'Agrupa tots els apartats que parlen d’un mateix tema.',
              'Completa la informació referent al programa d’actes de sant Bartomeu i santa Tecla.',
              'Adequa alguns apartats al fet que existeixi el Consell del Patrimoni Festiu de Festa Major de Sitges.',
            ],
          },
          { t: 'sub', text: 'Els quatre blocs del Protocol' },
          {
            t: 'ul',
            items: [
              'Bloc 1 — de l’apartat A a l’apartat E: conté els punts que defineixen la Festa Major de Sitges.',
              'Bloc 2 — dels apartats 1 al 8: conté els paràmetres organitzatius de la Festa.',
              'Bloc 3 — apartats F i G: inclou el programa d’actes de sant Bartomeu i de santa Tecla.',
              'Bloc 4 — apartats H i I: on es regula el propi protocol.',
            ],
          },
          {
            t: 'p',
            text: 'Pel que fa al programa, en aquesta versió s’han afegit els actes nous i els que es fan més enllà dels dies 23 i 24 d’agost i dels dies 22 i 23 de setembre. La versió anterior se centrava bàsicament en els actes d’aquests quatre dies.',
          },
          { t: 'sub', text: 'Actes afegits · sant Bartomeu' },
          {
            t: 'ul',
            items: [
              'El lliurament, el trasllat i la inauguració de l’exposició de la imatge de sant Bartomeu.',
              'L’actuació castellera (24 d’agost).',
              'El ball de Festa Major (24 d’agost).',
              'La celebració de sant Lli: el vermut, la missa en sufragi dels difunts de la vila i el concert ball (25 d’agost).',
              'La revetlla sardanista de cloenda (26 d’agost).',
              'L’exhibició castellera.',
            ],
          },
          { t: 'sub', text: 'Actes afegits · santa Tecla' },
          {
            t: 'ul',
            items: [
              'La Nit de foc.',
              ...
              'El lliurament, el trasllat i la inauguració de l’exposició de la imatge de santa Tecla.',
              'Les revetlles de Festa Major.',
              'L’actuació castellera (23 de setembre).',
              'L’exhibició castellera.',
            ],
          },
          {
            t: 'p',
            text: 'La creació del Consell del Patrimoni Festiu de la Festa Major, com a òrgan de participació ciutadana de l’Ajuntament de Sitges, amb funcions d’assessorament, formulació de propostes i suggeriments i d’adopció i execució en les matèries relacionades amb el Patrimoni de Festa Major de la vila, ha obligat a actualitzar els apartats 5.9, H i I.1.',
          },
        ],
      },
    ],
