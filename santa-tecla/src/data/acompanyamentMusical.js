/**
 * ACOMPANYAMENT MUSICAL DELS BALLS DEL SEGUICI ADULT
 *
 ...
 *
 * Els grups són els mateixos que a la Festa Major de Sant Bartomeu i s'apliquen
 * als actes del seguici adult de Santa Tecla. Les cercaviles del 20 de setembre
 * i les tres Matinals del 23 en queden fora: el document sí que hi diu quina
 * colla acompanya cada ball, però no se'n coneixen els components, de manera
 * que aquesta assignació viu a `sortides.js`, dins de l'ordre de cada acte.
 */

/** Actes que queden fora d'aquest quadre (tenen assignació pròpia a sortides.js). */
export const ACTES_SENSE_ACOMPANYAMENT = [
  'cercavila-gegants',
  'cercavila-dracs',
  'matinal-foc',
  'matinal-gran',
