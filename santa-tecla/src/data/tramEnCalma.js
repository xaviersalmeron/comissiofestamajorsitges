/**
 * ANNEX I — TRAM EN CALMA
 * Transcripció literal del document de consignes de Santa Tecla.
 * El text és el mateix que el de la Festa Major de Sant Bartomeu; només hi
 * canvia el tram concret, que a Santa Tecla és a la Processó del dia 23.
 */

export const TRAM_EN_CALMA = {
  ubicacio:
    'Carrer de Sant Gaudenci, amb inici a la meitat del carrer Sant Bartomeu i final passada la cruïlla amb carrer Sant Francesc (Processó de Santa Tecla).',
  queEs: [
