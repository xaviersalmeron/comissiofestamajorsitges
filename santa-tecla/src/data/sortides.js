...
export const SORTIDES = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    indicacions: [
      ...
      'ATENCIÓ! Es demana no aturar ni fer cap encesa especial sempre que no s’hagi comunicat prèviament. Queda prohibida encesa en el tram entre carrer de Port de n’Alegre amb carrer Rafael Llopart.',
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    indicacions: [
      ...
      'Les Cintes, Gitanes, Pastorets, Moixiganga, Cercolets i Castells queden muntats davant l’Ajuntament fins que tornin a passar els Gegants per davant. IMPORTANT: es recomana que ni els Pastorets ni els Cercolets facin el vers en muntar la bota.',
